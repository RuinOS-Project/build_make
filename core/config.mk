...
ifneq ($(RUIN_BUILD),)
include vendor/ruin/config/BoardConfig.mk
endif
...
ifneq ($(RUIN_ILD),)
ifneq ($(wildcard device/ruin/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/ruin/sepolicy/common/sepolicy.mk)
endif
endif
...
-include vendor/ruin/build/core/config.mk
